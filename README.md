...
Currently the script checks out Skia version `m102` and Aseprite version `1.3.6`. You can easily change this in `compile.sh` by changing the `-b` flag to the desired versions.
