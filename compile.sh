...
echo "Compiling skia"
gn gen out/Release-x64 --args="is_debug=false is_official_build=true skia_use_system_expat=false skia_use_system_icu=false skia_use_system_libjpeg_turbo=false skia_use_system_libpng=false skia_use_system_libwebp=false skia_use_system_z>
...
then
  git clone -b v1.3.6 --recursive https://github.com/aseprite/aseprite.git
fi
